...
class Auth extends CI_Controller {
	...
	public function register() {
        ...
        return;
			...
			$this->form_validation->set_rules('password', 'Password', 'trim|required|min_length[8]|max_length[250]');
    ...
    $this->output->set_content_type('application/json')->set_output(json_encode($response));
     ...
     public function forgotPassword() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            //generate random code and confirm the code is unique before proceeding
            do{
                $random_code = substr(md5(uniqid(mt_rand(), true)), 0, 6); 
            }while($this->user_model->checkCode($random_code));
  ...
  public function resetPassword() {
    ...
    $this->form_validation->set_rules('password', 'Password', 'trim|required|min_length[1]|max_length[250]');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $code = $_POST['code'];
                ...
                $encrypted_password = password_hash($password,PASSWORD_DEFAULT);
                  ...
                  $code = '';
                   $this->user_model->storeCode($user['id'],'');
